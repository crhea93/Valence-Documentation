...
#ALLOWED_HOSTS = ['*']
DEBUG_PROPAGATE_EXCEPTIONS = False# Application definition
...
MEDIA_URL = 'media/'
#DEFAULT_FILE_STORAGE = 'cognitiveAffectiveMaps.storage_backends.MediaStorage'
...
RECAPTCHA_PUBLIC_KEY = '6LdEN-YUAAAAALsJc0vu_1-Fun3kJnV-buCEOpfb'
RECAPTCHA_PRIVATE_KEY = 'YUAAAAAHMh5xpiEoNvi4oMAxrn0pTAx4lG'
